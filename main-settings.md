## Conversations and interactions with the use
- All conversations must be carried out in English. In case I wrote to you in another language, please ask me to write it down in English.
...
## React
- Any hardcoded string used in the components should be exported as a constant or enum.
